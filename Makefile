...
build_test:
	bash ./scripts/haechi/single-machine/go_build_executables.sh

clean_port:
	bash ./scripts/haechi/clear_port.sh

clean_client:
	bash ./scripts/haechi/clear_client.sh

build_EC2:
	bash ./scripts/haechi/EC2-test/build_EC2_executables.sh