...
import (
	...
	ahlNode "github.com/tendermint/tendermint/csconsensus/ahl/coordinator/validator"
)
...
func (app *AhlBeaconApplication) DeliverTx(req abcitypes.RequestDeliverTx) abcitypes.ResponseDeliverTx {
	...
	if tx_json.Tx_type == ahlNode.InterShard_TX_Verify {
		// println("Beacon chain This is a verification transaction")
		...
		// println("Beacon chain This is a commit transaction from sender")
