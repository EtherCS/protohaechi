...
import (
	...
	haechiSyncNode "github.com/tendermint/tendermint/csconsensus/haechi-sync/coordinator/validator"
)
...
func NewHaechiBeaconApplication(node *haechiSyncNode.ValidatorInterface) *HaechiBeaconApplication {
